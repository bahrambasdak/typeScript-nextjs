      ...
      <div className="h-[1em] relative overflow-hidden">
        ...
        <div className="absolute flex h-[1em] top-[-0.1em] left-0 items-center">
          {text.split("").map((t, i) => (
            <span
              key={i + 2}
              className="even:translate-y-[-1em] odd:translate-y-[1em]  group-hover/letter:even:animate-letterDown1  group-hover/letter:odd:animate-letterUp1 transition-all ease-in-out duration-300 [animation-fill-mode:backwards]"
            >
              {t}
            </span>
          ))}
